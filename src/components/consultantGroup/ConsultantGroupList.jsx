                                        ...
                                        <tbody>
                                            {
                                                currentGroup.map((group, index) => (
                                                    <tr key={index} onClick={() => handleRowClick(group.id)} 
                                                        className="border-b border-neutral-200 bg-black/[0.02] dark:border-white/10 cursor-pointer">
