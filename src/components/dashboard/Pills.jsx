...
const Pills = () => {
    return (
        <div className="bg-white py-3 rounded-md shadow mb-6 px-3">
            <p className='text-customPrimary font-medium text-base '>Quick Summary</p>
            <p className='text-xs text-gray-400 pb-6'>Today's Summary</p>
            <div class="grid grid-cols-2 gap-4 md:grid-cols-4 ">
                <div class="bg-red-100 p-3 rounded-md h-32">
                ...
                <div class="bg-orange-100 p-3 rounded-md h-32">
                ...
                <div class="bg-green-100 p-3 rounded-md h-32">
                ...
                <div class="bg-indigo-100 p-3 rounded-md h-32">
