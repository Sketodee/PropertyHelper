...
function SideNavbar({darkModeHandler, dark}) {
  return (
    <div className="helvetica">
      <Disclosure as="div">
        <Disclosure.Button className="absolute top-6 right-4 inline-flex items-center peer justify-start rounded-md p-2 text-gray-800 hover:bg-gray-900">
          <GiHamburgerMenu
            className="block md:hidden h-6 w-6 z-50"
            aria-hidden="true"
          />
        </Disclosure.Button>
        <div className="overflow-y-auto p-6 w-1/2 h-screen z-20 fixed top-0 -left-96 lg:left-0 lg:w-1/6 peer-focus:left-0 peer:transition ease-out delay-250 duration-300 bg-white dark:bg-blue-900 border-r-2 border-gray-100">
          <div className="flex flex-col justify-start item-center">
            <h1 className="text-2xl cursor-pointer font-bold text-blue-500 border-b border-gray-100 pb-4 w-full sora">
              Estate Helper
            </h1>
